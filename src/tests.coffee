...
@[ "(v4) $sort 6" ] = ( T, done ) ->
  ...
  sort = ( directions_and_keys..., matcher, handler ) =>
    info directions_and_keys
    input = D.new_stream()
    pipeline = ( D.$sort { direction, key, } for [ direction, key, ] in directions_and_keys ).reverse()
    input
      .pipe D.new_stream { pipeline, }
    ...
    D.on_finish input, handler
    for probe in probes
      probe[ 'date' ] = ( new Date probe ) if CND.isa_text probe[ 'date' ]
      debug '7765', probe
      D.send input, probe
    D.end input
  #.........................................................................................................
  probes = [
    { date: '2016 Apr 19 17:47', size:  1069547520, name: "ubuntu-14.04.4-desktop-amd64.iso",                       }
    { date: '2016 Apr 20 00:27', size:     1216498, name: "Vermeer-view-of-delft.jpg",                              }
    { date: '2016 Feb  4 18:08', size:    28121472, name: "actions.pdf",                                            }
    { date: '2016 Feb 19 12:43', size:       61140, name: "rss.opml",                                               }
    { date: '2016 Jan 16 20:07', size:   126810054, name: "Inside Star Trek Voyager.mp4",                           }
    { date: '2016 Jan 16 21:55', size:   300421011, name: "Star Trek Secrets of the Universe.mp4",                  }
    { date: '2016 Jan 30 19:40', size:     8645163, name: "rack-experiment.zip",                                    }
    { date: '2016 Jun  9 17:20', size:    71511772, name: "Software Defined Networking - Computerphile.mp4",        }
    { date: '2016 Jun 12 18:32', size:   444219478, name: "Syntaxation • Douglas Crockford.mp4",                    }
    { date: '2016 Jun 16 15:15', size:   194876109, name: "Another Go at Language Design.mp4",                      }
    { date: '2016 Jun 16 15:40', size:   452146120, name: "Go for Pythonistas.mp4",                                 }
    { date: '2016 Jun 16 15:58', size:   238955286, name: "Building Services in Go.mp4",                            }
    { date: '2016 Jun 16 16:02', size:    29880564, name: "Is Glass a Liquid.mp4",                                  }
    { date: '2016 Jun 16 16:02', size:    70266384, name: "Celsius Didn't Invent Celsius.mp4",                      }
    { date: '2016 Jun 16 16:14', size:    89684342, name: "INSIDE a Spherical Mirror.mp4",                          }
    { date: '2016 Jun 16 16:18', size:   146666578, name: "How Earth Moves.mp4",                                    }
    { date: '2016 Jun 16 16:20', size:   131406982, name: "Dynamic Languages Strike Back.mp4",                      }
    { date: '2016 May  4 11:51', size:  1537474560, name: "manjaro-xfce-15.12-x86_64.iso",                          }
    { date: '2016 May  6 12:09', size:  1828716544, name: "antergos-2016.04.22-x86_64.iso",                         }
    { date: '2016 May  6 14:35', size:  1485881344, name: "ubuntu-16.04-desktop-amd64.iso",                         }
    { date: '2016 May  8 01:16', size:    12292718, name: "CJK Character Component Standard 20150112165337190.pdf", }
    { date: '2016 May 21 11:06', size:     1313746, name: "2015_Logography_and_the_classification_o.pdf",           }
    { date: '2004 Aug  4 00:00', size:    10500792, name: "simsun.ttc",                                             }
    { date: '2015 Dec 20 00:00', size:     7740439, name: "Ricci, Mnemotechnics, btv1b9006393v.pdf",                }
    { date: '2015 Apr 18 00:00', size:    26073977, name: "Perfect Numbers and Mersenne Primes - Numberphile.mp4",  }
    { date: '2015 Nov  1 00:00', size:    70623822, name: "atom-amd64(1).deb",                                      }
    { date: '2015 Nov  2 00:00', size:    70040746, name: "atom-amd64(2).deb",                                      }
    { date: '2015 Nov 18 00:00', size:      362700, name: "CharlesBabbageLawsOfMechanicalNotation.pdf",             }
    { date: '2015 Oct 17 00:00', size:    19351620, name: "Legge1899.pdf",                                          }
    { date: '2015 Oct 22 00:00', size:    69957572, name: "atom-amd64.deb",                                         }
    { date: '2015 Oct 22 00:00', size:   369306221, name: "The Big Bang Theory - Best of Star Trek.mp4",            }
    ]
  #.........................................................................................................
  step ( resume ) =>
