...
@[ "(v4) file reading gauge" ] = ( T, done ) ->
  ...
  collector = []
  matchers  = []
  input     = D.new_stream 'read', 'progress', { path, }
  input
    .pipe D.$split()
    #.....................................................................................................
    .pipe do =>
...
#-----------------------------------------------------------------------------------------------------------
@[ "(v4) asnychronous error propagation with new_stream from path" ] = ( T, done ) ->
  step = ( require 'coffeenode-suspend' ).step
  step ( resume ) =>
    debug '40300', path = 'no-such-file'
    input = D.new_stream { path, }
    input.pipe D.$show()
    input.on 'error', ( error ) => warn error
    done()
  return null
...
unless module.parent?
  ...
  ### ----------------===#O#===--------------------###
  "(v4) _new_stream_from_url" # should include mock server or test for connectivity
  ### ----------------===#O#===--------------------###
