...
(function() {
  ...
  this["(v4) $bridge"] = function(T, done) {
    var MSP, has_ended, has_url, input, output, report_failure;
    MSP = require('mississippi');
    has_url = false;
    has_ended = false;
    output = (require('fs')).createWriteStream('/tmp/foo');
    D.$bridge = function(stream) {
      output.on('close', (function(_this) {
        return function() {
          return urge('close');
        };
      })(this));
      return output.on('finish', (function(_this) {
        return function() {
          return urge('finish');
        };
      })(this));
    ...
    return setTimeout(report_failure, 2000);
  };
  ...
  this["(v4) new_file_readstream"] = function(T, done) {
    ...
    })(this))).pipe(D.$bridge((require('fs')).createWriteStream('/tmp/foo'))).pipe(D.$on_end((function(_this) {
      return function() {
        if (has_url) {
          T.ok(true);
        } else {
