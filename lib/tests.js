...
(function() {
  ...
  this["(v4) $split_tsv with configurable splitter"] = function(T, done) {
    var count, input;
    count = 0;
    input = D.new_stream({
    ...
    return input.pipe(D.$split_tsv({
      splitter: /[\x20\t]{2,}/g
    })).pipe(D.$collect()).pipe($((function(_this) {
      return function(result) {
        count += 1;
        return T.eq(result, [['u-arab', 'Arabic'], ['u-arrow', 'Arrows'], ['u-block', 'Block Elements'], ['u-bopo', 'Bopomofo']]);
      };
    })(this))).pipe($('finish', (function(_this) {
      return function() {
        T.eq(count, 1);
