...
(function() {
  ...
  this["(v4) file reading gauge"] = function(T, done) {
    var $cast, $colorize, collector, matchers, path, show, step;
    step = require('coffeenode-suspend').step;
    ...
    show = (function(_this) {
      return function(table_settings, as_lists, matcher, handler) {
        ...
        return input.pipe(D.$throttle_bytes(1e5)).pipe((function() {
          var Progress_bar, bar, file_size, format, progress_bar_settings;
