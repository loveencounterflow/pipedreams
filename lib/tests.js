...
(function() {
  ...
  if (module.parent == null) {
    include = ["(v4) $lockstep 1", "(v4) $lockstep fails on streams of unequal lengths without fallback", "(v4) $lockstep succeeds on streams of unequal lengths with fallback", "(v4) $batch and $spread", "(v4) $split_each_line"];
    this._prune();
    this["(v4) $split_each_line"]();
  }
