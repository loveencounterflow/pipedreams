...
(function() {
  ...
  this["(v4) $select (1)"] = function(T, done) {
    ...
    matchers = ["un", "deux", "troix", "beaucoup", "pass this one", "—————", "one", "un", "—————", "one", "un", "eins", "—————", "two", "—————", "drei", "viele", "guess we're done here"];
  ...
  this["(v4) $select (2)"] = function(T, done) {
    ...
    my_input = D.new_stream();
    my_input.pipe(D.$select(select_drop_and_pass_events)).pipe(D.$select(select_draw_line_events, draw_line_track)).pipe(D.$select(select_language_events, language_track)).pipe(bridgehead).pipe($((function(_this) {
      return function(data) {
  ...
  if (module.parent == null) {
    ...
    /* ----------------===#O#===-------------------- */
    include = ["(v4) $select (1)", "(v4) $select (2)", "(v4) duplex stream creation"];
    this._prune();
    this._main();
  }
