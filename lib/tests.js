...
(function() {
  ...
  this["(v4) stream sigils"] = function(T, done) {
    ...
    help('002', D.new_stream({
      file: '/tmp/foo'
    }));
    help('003', D.new_stream('lines', {
      file: '/tmp/foo'
    }));
    help('004', D.new_stream('write', {
      file: '/tmp/foo'
    }));
    help('005', D.new_stream('write', 'lines', {
      file: '/tmp/foo'
    }));
    help('006', D.new_stream({
      pipeline: [
        $((function(_this) {
          return function(data) {
            return null;
