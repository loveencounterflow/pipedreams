...
(function() {
  ...
  this["(empty-string) can send empty strings (w/ mississippi pipeline)"] = function(T, done) {
    var MSP, input, matchers, through;
    MSP = require('mississippi');
    matchers = ['', ''];
  ...
  this["(empty-string) can send empty strings (validate mississippi through works as such)"] = function(T, done) {
    var MSP, input, matchers, sub_input, sub_output, through;
    MSP = require('mississippi');
    matchers = [];
  ...
  this["(empty-string) can send empty strings (validate mississippi through works with empty strings)"] = function(T, done) {
    var MSP, input, matchers, sub_input, sub_output, through;
    MSP = require('mississippi');
    matchers = ['', ''];
    sub_input = D.new_stream();
  ...
  this["(empty-string) can send empty strings (validate mississippi pipeline works as such)"] = function(T, done) {
    var MSP, collect, collector, input, matchers_1, matchers_2, sub_input, sub_output, through;
    MSP = require('mississippi');
    ...
    input = D.new_stream();
    input.pipe(through).pipe($((function(_this) {
      return function(data) {
        return urge(data);
      };
    })(this))).pipe($((function(_this) {
    ...
    })(this))).pipe($validate_probes(T, matchers_2)).pipe(D.$on_finish((function(_this) {
      return function() {
  ...
  this["(empty-string) can send empty strings (validate mississippi pipeline works with empty strings)"] = function(T, done) {
    var MSP, collect, collector, input, matchers_1, matchers_2, sub_input, sub_output, through;
    MSP = require('mississippi');
  ...
  this["(empty-string) can send empty strings (validate mississippi pipe works as such)"] = function(T, done) {
    var MSP, collect, collector, filter, handler, input, matchers_1, matchers_2, show;
    MSP = require('mississippi');
    matchers_1 = ["A text", "with a few", "lines", "none", "of which", "are empty."];
    matchers_2 = [];
    collector = [];
  ...
  this["(empty-string) can send empty strings (validate mississippi pipe works with empty strings)"] = function(T, done) {
    var MSP, collect_1, collect_2, collector_1, collector_2, filter, handler, input, matchers_1, matchers_2, show;
    MSP = require('mississippi');
    matchers_1 = ["A text", "with a few", "lines", "", "some", "", "of which", "are empty."];
    matchers_2 = ["", ""];
    collector_1 = [];
  ...
  this["(empty-string) can send empty strings (validate mississippi duplex works as such)"] = function(T, done) {
    var MSP, collect, collector_1, filter, handler, input, matchers_1, receiver, sender, show, through;
    MSP = require('mississippi');
    matchers_1 = ["A text", "with a few", "lines", "none", "of which", "are empty."];
    collector_1 = [];
    collect = $((function(_this) {
    ...
    input.pipe(through).pipe(D.$show()).pipe(D.$on_finish((function(_this) {
      return function() {
        T.eq(collector_1, matchers_1);
        return done();
      };
  ...
  this["(empty-string) can send empty strings (validate mississippi duplex works with empty strings)"] = function(T, done) {
    var MSP, collect_1, collect_2, collector_1, collector_2, filter, handler, input, matchers_1, matchers_2, receiver, sender, show, through;
    MSP = require('mississippi');
    matchers_1 = ["A text", "with a few", "lines", "", "some", "", "of which", "are empty."];
    matchers_2 = ["", ""];
    collector_1 = [];
  ...
  this["(empty-string) can send empty strings ($split_2) (1)"] = function(T, done) {
    var input, matchers, probe;
    probe = "A text\nwith a few\n\nlines\n\nsome of which\nare empty.";
    debug('4412', rpr(probe));
    matchers = ['', ''];
    input = D.new_stream();
    input.pipe(D.$split_2()).pipe(D.$show()).pipe(D.$on_finish(done));
    D.send(input, probe);
    return D.end(input);
  };

  this["(empty-string) can send empty strings ($split_2) (2)"] = function(T, done) {
    var input, matchers, probe;
    probe = "A text\nwith a few\n\nlines\n\nsome of which\nare empty." + '\n\n';
    debug('4412', rpr(probe));
    matchers = ['', ''];
  ...
  this["(empty-string) $tabulate"] = function(T, done) {
    var $cast, show, step;
    step = require('coffeenode-suspend').step;
    $cast = (function(_this) {
      return function() {
    ...
    show = (function(_this) {
      return function(table_settings, as_lists, matcher, handler) {
        ...
        })()).pipe(D.$tabulate(table_settings)).pipe($(function(row) {
          return echo(row);
        })).pipe(D.$on_finish(handler));
      };
    })(this);
  ...
  if (module.parent == null) {
    include = ["(empty-string) can send empty strings ($split) (1)", "(empty-string) can send empty strings ($split) (2)", "(empty-string) can send empty strings ($split_2) (1)", "(empty-string) can send empty strings ($split_2) (2)", "(empty-string) duplexer2 works with empty strings", "(empty-string) new D.duplex, new_stream from pipeline work with empty strings", "(v4) stream sigils"];
    this._prune();
    this._main();
  }
