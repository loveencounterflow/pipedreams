...
(function() {
  ...
  if (module.parent == null) {
    include = ["(v4) new_stream_from_pipeline (1a)", "(v4) new_stream_from_pipeline (3)", "(v4) new_stream_from_pipeline (4)", "(v4) new_stream_from_text", "(v4) new_stream_from_text doesn't work synchronously", "(v4) new_stream_from_text (2)", "(v4) observer transform called with data `null` on stream end", "(v4) README demo (1)", "(v4) D.new_stream", "(v4) stream / transform construction with through2 (1)", "(v4) D.new_stream_from_pipeline", "(v4) $async with method arity 2", "(v4) $async with method arity 3", "(v4) $sort 1", "(v4) $sort 2", "(v4) $sort 3", "(v4) $sort 4", "(v4) $lockstep 1", "(v4) $lockstep fails on streams of unequal lengths without fallback", "(v4) $lockstep succeeds on streams of unequal lengths with fallback", "(v4) $batch and $spread", "(v4) $split_tsv (1)", "(v4) $split_tsv (2)", "(v4) $split_tsv (3)", "(v4) $split_tsv (4)"];
    this._prune();
    this._main();
  }
