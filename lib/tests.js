...
(function() {
  ...
  this["(empty-string) can send empty strings"] = function(T, done) {
    var input, matchers, through;
    matchers = ['', ''];
    through = D.new_stream({
      pipeline: [
        D.$show(), $((function(_this) {
          return function(data) {
            return urge(data);
          };
        })(this))
