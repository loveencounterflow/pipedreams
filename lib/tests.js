...
(function() {
  ...
  this["(v4) stream / transform construction with through2 (2)"] = function(T, T_done) {
    var S, db, delay, glyph, i, len, read_one_phrase, ref, t2_settings, through2, transform_flush, transform_main;
    through2 = require('through2');
    t2_settings = {};
    S = {};
    ...
    transform_main = function(glyph, encoding, handler) {
      var push;
      push = this.push.bind(this);
      push([glyph, 'start']);
    ...
    S.input.pipe(through2.obj(t2_settings, transform_main, transform_flush)).pipe(D.$show()).pipe(D.$on_end((function(_this) {
      return function() {
        return T_done();
      };
    })(this)));
