...
(function() {
  ...
  this["(empty-string) can send empty strings (validate mississippi pipe works as such)"] = function(T, done) {
    var MSP, collect, collector, handler, input, matchers_1, matchers_2, sub_input, sub_output, through;
    MSP = require('mississippi');
  ...
  if (module.parent == null) {
    include = ["(empty-string) can send empty strings (validate mississippi pipe works as such)"];
    this._prune();
    this._main();
  }
