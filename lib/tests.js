...
(function() {
  ...
  if (module.parent == null) {
    include = ["(v4) all remit methods have opt-in end detection (1)", "(v4) all remit methods have opt-in end detection (2)", "(v4) all remit methods have opt-in end detection (3)", "(v4) all remit methods have opt-in end detection (4)", "(v4) all remit methods have opt-in end detection (5)", "(v4) all remit methods have opt-in end detection (6)"];
    this._prune();
    this._main();
  }
