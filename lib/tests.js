...
(function() {
  ...
  this["(v4) $sort 6"] = function(T, done) {
    var TABLE, _new_table_stream, i, len, probe, probes, sort, step, table_settings;
    step = (require('coffeenode-suspend')).step;
    TABLE = require('table');
    _new_table_stream = TABLE.createStream;
    table_settings = {
      border: TABLE.getBorderCharacters('void'),
      drawJoin: (function(_this) {
        return function() {
          return false;
        };
      })(this),
    ...
    sort = (function(_this) {
      return function() {
        var direction, directions_and_keys, handler, i, input, j, key, len, matcher, new_table_stream, pipeline, probe;
        ...
        new_table_stream = function() {
          var table_stream;
          table_stream = _new_table_stream(table_settings);
          return $(function(data, send) {
            table_stream.write(data);
            return send(data);
          });
        };
