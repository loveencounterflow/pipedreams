...
(function() {
  var $, $async, $split_tsv, CND, D, TMP, _temp_thing, alert, badge, debug, delay, echo, help, include, info, input, isa_stream, log, path_1, resolve_path, resolve_temp_path, rpr, sleep, temp_home, test, urge, warn, whisper,
    slice = [].slice,
  ...
  if (module.parent == null) {
    include = ["(v4) _new_stream_from_path (1)"];
    ...
    input.pipe(D.$collect()).pipe($((function(_this) {
      return function(lines) {
        return null;
      };
    })(this))).pipe(D.$on_end((function(_this) {
