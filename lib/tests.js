...
(function() {
    ...
    sort = (function(_this) {
      return function() {
        ...
        for (j = 0, len = probes.length; j < len; j++) {
          probe = probes[j];
          if (CND.isa_text(probe['date'])) {
            probe['date'] = new Date(probe);
          }
          debug('7765', probe);
          D.send(input, probe);
        }
  ...
  if (module.parent == null) {
    include = ["(v4) $sort 4", "(v4) $sort 5", "(v4) $sort 6"];
    this._prune();
    this._main();
  }
