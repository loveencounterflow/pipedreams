...
(function() {
  var $, $async, $split_tsv, CND, D, TMP, _temp_thing, alert, badge, debug, delay, echo, help, include, info, isa_stream, log, resolve_path, resolve_temp_path, rpr, temp_home, test, urge, warn, whisper,
    slice = [].slice,
