...
(function() {
  ...
  this["_(v4) _new_stream_from_path (3) (inner)"] = function(idx, probes, handler) {
    var MSP, path, read_sample, step, write_sample;
  ...
  this["(v4) $sort 6"] = function(T, done) {
    ...
    sort = (function(_this) {
      return function() {
        var direction, directions_and_keys, handler, i, input, key, matcher, pipeline;
  ...
  if (module.parent == null) {
    include = ["(v4) _new_stream_from_path (2)", "(v4) _new_stream_from_pipeline (1a)", "(v4) _new_stream_from_pipeline (3)", "(v4) _new_stream_from_pipeline (4)", "(v4) _new_stream_from_text", "(v4) _new_stream_from_text (2)", "(v4) observer transform called with data `null` on stream end", "(v4) D.new_stream", "(v4) stream / transform construction with through2 (1)", "(v4) D._new_stream_from_pipeline", "(v4) $async with method arity 2", "(v4) $async with method arity 3", "(v4) $lockstep 1", "(v4) $lockstep fails on streams of unequal lengths without fallback", "(v4) $lockstep succeeds on streams of unequal lengths with fallback", "(v4) $batch and $spread", "(v4) streams as transforms and v/v (1)", "(v4) streams as transforms and v/v (2)", "(v4) file stream events (1)", "(v4) transforms below output receive data events (1)", "(v4) transforms below output receive data events (2)", "(v4) _new_stream_from_url", "(v4) new_stream README example (1)", "(v4) new_stream README example (2)", "(v4) new_stream README example (3)", "(v4) _new_stream_from_path with encodings", "(v4) _new_stream_from_path (raw)", "(v4) new new_stream signature (1)", "(v4) new new_stream signature (2)", "(v4) _new_stream_from_path (1)", "(v4) _new_stream_from_path (3)", "(v4) $split_tsv (3)", "(v4) $split_tsv (4)", "(v4) read TSV file (1)", "(v4) TSV whitespace trimming", "(v4) $split_tsv (1)", "(v4) $intersperse (1)", "(v4) $intersperse (2)", "(v4) $intersperse (3)", "(v4) $intersperse (3a)", "(v4) $intersperse (4)", "(v4) $join (1)", "(v4) $join (2)", "(v4) $join (3)", "(v4) $as_json_list (1)", "(v4) $as_json_list (2)", "(v4) $as_json_list (2a)", "(v4) $as_json_list (2b)", "(v4) $as_json_list (2c)", "(v4) $as_json_list (3)", "(v4) symbols as data events (1)", "(v4) symbols as data events (2)", "(v4) stream sigils", "(v4) $sort 1", "(v4) $sort 2", "(v4) $sort 3", "(v4) $sort 4", "(v4) $sort 5", "(v4) $sort 6", "(v4) $as_tsv", "(v4) $batch (1)", "(v4) $batch (2)", "(v4) all remit methods have opt-in end detection (1)", "(v4) all remit methods have opt-in end detection (2)", "(v4) all remit methods have opt-in end detection (3)", "(v4) all remit methods have opt-in end detection (4)", "(v4) README demo (1)", "(v4) README demo (2)", "(v4) README demo (3)"];
    this._prune();
    this._main();
  }
