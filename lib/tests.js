...
(function() {
  ...
  this["(v4) $split_each_line plain"] = function(T, done) {
    var input, matcher;
    input = D.new_stream();
    input.pipe(D.$split_each_line()).pipe(D.$collect()).pipe(D.$show()).pipe($(function(data) {
      if (data != null) {
        return T.eq(data, matcher);
      }
    })).pipe(D.$on_end((function(_this) {
    ...
    matcher = [['a', 'text'], ['with', 'a number'], ['of', 'lines'], ['u-cjk/9e1f', '鸟', '⿴乌丶'], ['u-cjk/9e20', '鸠', '⿰九鸟'], ['u-cjk/9e21', '鸡', '⿰又鸟'], ['u-cjk/9e22', '鸢', '⿱弋鸟'], ['u-cjk/9e23', '鸣', '⿰口鸟']];
    D.send(input, "a\ttext\nwith\ta number\nof\tlines\n");
    D.send(input, "u-cjk/9e1f\t鸟\t⿴乌丶\nu-cjk/9e20\t鸠\t⿰九鸟\nu-cjk/9e21\t鸡\t⿰又鸟\nu-cjk/9e22\t鸢\t⿱弋鸟\nu-cjk/9e23\t鸣\t⿰口鸟");
    D.end(input);
    return null;
  };

  this["(v4) $split_each_line with comments, empty lines"] = function(T, done) {
    var input, matcher;
    input = D.new_stream();
    input.pipe(D.$split_each_line()).pipe(D.$collect()).pipe(D.$show()).pipe($(function(data) {
      if (data != null) {
    ...
    matcher = [['u-cjk/9e1f', '鸟', '⿴乌丶'], ['u-cjk/9e20', '鸠', '⿰九鸟'], ['u-cjk/9e21', '鸡', '⿰又鸟'], ['u-cjk/9e22', '鸢', '⿱弋鸟'], ['u-cjk/9e23', '鸣', '⿰口鸟']];
    D.send(input, "u-cjk/9e1f\t鸟\t⿴乌丶\nu-cjk/9e20\t鸠\t⿰九鸟\nu-cjk/9e21\t鸡\t⿰又鸟\nu-cjk/9e22\t鸢\t⿱弋鸟\nu-cjk/9e23\t鸣\t⿰口鸟");
    D.end(input);
    return null;
  };
  ...
  if (module.parent == null) {
    include = ["(v4) $lockstep 1", "(v4) $lockstep fails on streams of unequal lengths without fallback", "(v4) $lockstep succeeds on streams of unequal lengths with fallback", "(v4) $batch and $spread", "(v4) $split_each_line plain", "(v4) $split_each_line with comments, empty lines"];
    this._prune();
    this._main();
  }
