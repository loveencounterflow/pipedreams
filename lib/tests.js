...
(function() {
  ...
  this["(v4) $tap, $as_json_line"] = function(T, done) {
    ...
    input.pipe(D.$split_tsv({
      ...
      seed: 998791
    })).pipe($cast_1()).pipe(D.$tap(bystream)).pipe($cast_2()).pipe($((function(_this) {
      return function(data) {
