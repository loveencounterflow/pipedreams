...
(function() {
  ...
  this["(v4) $as_json_list (2c)"] = function(T, done) {
    ...
    f = function(path, handler) {
      ...
      data_items = [42, 'a string', null, false, true];
  ...
  if (module.parent == null) {
    include = ["(v4) $intersperse (1)", "(v4) $intersperse (2)", "(v4) $intersperse (3)", "(v4) $intersperse (3a)", "(v4) $intersperse (4)", "(v4) $intersperse (5)", "(v4) $intersperse (6)", "(v4) $as_json_list (2a)", "(v4) $as_json_list (2b)", "(v4) $as_json_list (2c)"];
    this._prune();
    this._main();
  }
