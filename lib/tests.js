...
(function() {
  ...
  this["(v4) _new_stream_from_url"] = function(T, done) {
    ...
    sink = D.new_stream('devnull');
    D.on_finish(sink, done);
    input.pipe(D.$split()).pipe(D.$show()).pipe(sink);
    return null;
  };
