...
(function() {
  ...
  this["(v4) can send empty strings"] = function(T, done) {
  ...
  this["(v4) can send empty strings (split) (1)"] = function(T, done) {
  ...
  this["(v4) can send empty strings (split) (2)"] = function(T, done) {
    var input, matchers, probe;
    probe = "A text\nwith a few\n\nlines\n\nsome of which\nare empty." + '\n\n';
    debug('4412', rpr(probe));
    matchers = ['', ''];
  ...
  if (module.parent == null) {
    include = ["(v4) can send empty strings", "(v4) can send empty strings (split) (1)"];
    this._prune();
    this._main();
  }
