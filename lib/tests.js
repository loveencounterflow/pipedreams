...
(function() {
  var $, $async, $validate_probes, CND, D, TMP, _temp_thing, alert, badge, debug, delay, echo, grep_italic_results_with_ignore_case, grep_italic_results_with_matching_case, help, include, info, isa_stream, log, resolve_path, resolve_temp_path, rpr, sleep, temp_home, test, urge, warn, whisper,
    slice = [].slice,
  ...
  grep_italic_results_with_matching_case = ["Bold Italic Greek Mathematical Symbols  1D71C", "Bold Italic Greek Mathematical Symbols, Sans-serif  1D790", "Bold Italic Mathematical Symbols  1D468", "Bold Italic Mathematical Symbols, Sans-serif  1D63C", "Double-struck Italic Mathematical Symbols 2145", "Greek Mathematical Symbols, Bold Italic 1D71C", "Greek Mathematical Symbols, Italic  1D6E2", "Greek Mathematical Symbols, Sans-serif Bold Italic  1D790", "Italic Greek Mathematical Symbols 1D6E2", "Italic Greek Mathematical Symbols, Bold 1D71C", "Italic Greek Mathematical Symbols, Sans-serif Bold  1D790", "Italic Mathematical Symbols 1D434", "Italic Mathematical Symbols, Bold 1D468", "Italic Mathematical Symbols, Sans-serif 1D608", "Italic Mathematical Symbols, Sans-serif Bold  1D63C", "Italic, Old 10300", "Mathematical Symbols, Bold Italic 1D468", "Mathematical Symbols, Bold Italic Greek 1D71C", "Mathematical Symbols, Italic  1D434", "Mathematical Symbols, Italic Greek  1D6E2", "Mathematical Symbols, Sans-serif Bold Italic  1D63C", "Mathematical Symbols, Sans-serif Bold Italic Greek  1D790", "Mathematical Symbols, Sans-serif Italic 1D608", "Numerals, Old Italic  10320", "Old Italic  10300", "Sans-serif Bold Italic Greek Mathematical Symbols 1D790", "Sans-serif Bold Italic Mathematical Symbols 1D63C", "Sans-serif Italic Mathematical Symbols  1D608", "Symbols, Bold Italic Greek Mathematical 1D71C", "Symbols, Bold Italic Mathematical 1D468", "Symbols, Double-struck Italic Mathematical  2145", "Symbols, Italic Greek Mathematical  1D6E2", "Symbols, Italic Mathematical  1D434", "Symbols, Sans-serif Bold Italic Greek Mathematical  1D790", "Symbols, Sans-serif Bold Italic Mathematical  1D63C", "Symbols, Sans-serif Italic Mathematical 1D608"];

  grep_italic_results_with_ignore_case = ["Bold Italic Greek Mathematical Symbols  1D71C", "Bold Italic Greek Mathematical Symbols, Sans-serif  1D790", "Bold Italic Mathematical Symbols  1D468", "Bold Italic Mathematical Symbols, Sans-serif  1D63C", "D, DOUBLE-STRUCK ITALIC CAPITAL 2145", "D, DOUBLE-STRUCK ITALIC SMALL 2146", "Double-struck Italic Mathematical Symbols 2145", "E, DOUBLE-STRUCK ITALIC SMALL 2147", "Greek Mathematical Symbols, Bold Italic 1D71C", "Greek Mathematical Symbols, Italic  1D6E2", "Greek Mathematical Symbols, Sans-serif Bold Italic  1D790", "I, DOUBLE-STRUCK ITALIC SMALL 2148", "Italic Greek Mathematical Symbols 1D6E2", "Italic Greek Mathematical Symbols, Bold 1D71C", "Italic Greek Mathematical Symbols, Sans-serif Bold  1D790", "Italic Mathematical Symbols 1D434", "Italic Mathematical Symbols, Bold 1D468", "Italic Mathematical Symbols, Sans-serif 1D608", "Italic Mathematical Symbols, Sans-serif Bold  1D63C", "Italic, Old 10300", "J, DOUBLE-STRUCK ITALIC SMALL 2149", "Mathematical Symbols, Bold Italic 1D468", "Mathematical Symbols, Bold Italic Greek 1D71C", "Mathematical Symbols, Italic  1D434", "Mathematical Symbols, Italic Greek  1D6E2", "Mathematical Symbols, Sans-serif Bold Italic  1D63C", "Mathematical Symbols, Sans-serif Bold Italic Greek  1D790", "Mathematical Symbols, Sans-serif Italic 1D608", "Numerals, Old Italic  10320", "Old Italic  10300", "Sans-serif Bold Italic Greek Mathematical Symbols 1D790", "Sans-serif Bold Italic Mathematical Symbols 1D63C", "Sans-serif Italic Mathematical Symbols  1D608", "Symbols, Bold Italic Greek Mathematical 1D71C", "Symbols, Bold Italic Mathematical 1D468", "Symbols, Double-struck Italic Mathematical  2145", "Symbols, Italic Greek Mathematical  1D6E2", "Symbols, Italic Mathematical  1D434", "Symbols, Sans-serif Bold Italic Greek Mathematical  1D790", "Symbols, Sans-serif Bold Italic Mathematical  1D63C", "Symbols, Sans-serif Italic Mathematical 1D608"];

  this["(v4) grep: new stream from pattern and path (basic pattern)"] = function(T, done) {
    var collector, input, output, path, pattern;
    path = resolve_path(__dirname, '../test-data/Unicode-index.txt');
    pattern = /Italic/;
    input = D._new_stream_from_pattern_and_path({
      pattern: pattern,
      path: path
    });
    output = D.new_stream('devnull');
    ...
    input.pipe($((function(_this) {
      return function(data) {
        return info(CND.steel(JSON.stringify(data)));
      };
    })(this))).pipe($((function(_this) {
      return function(data) {
        return collector.push(data);
      };
    })(this))).pipe(D.$as_line()).pipe(output).pipe($('finish', (function(_this) {
      return function() {
        help('ok');
  ...
  this["(v4) grep: new stream from pattern and path (with ignore-case)"] = function(T, done) {
    var collector, input, output, path, pattern;
    path = resolve_path(__dirname, '../test-data/Unicode-index.txt');
    pattern = /italic/i;
    input = D._new_stream_from_pattern_and_path({
  ...
  this["(v4) grep: new stream from pattern and path (no results without ignore-case)"] = function(T, done) {
    var collector, input, output, path, pattern;
    path = resolve_path(__dirname, '../test-data/Unicode-index.txt');
    pattern = /italic/;
    input = D._new_stream_from_pattern_and_path({
  ...
  this["(v4) grep: new stream from pattern and path (error with non-existent file)"] = function(T, done) {
    var collector, input, output, path, pattern;
  ...
  if (module.parent == null) {
    ...
    /* ----------------===#O#===-------------------- */
    include = ["(v4) grep: new stream from pattern and path (basic pattern)", "(v4) grep: new stream from pattern and path (with ignore-case)", "(v4) grep: new stream from pattern and path (no results without ignore-case)"];
    this._prune();
    this.f = function() {
      var input, output, path, pattern;
      ...
      output = D.new_stream('write', {
        path: '/tmp/guoxuedashi-excerpts-with-yitizi-excerpts.txt'
      });
      input.pipe(D.$as_line()).pipe(output).pipe($('finish', (function(_this) {
        return function() {
          return help('ok');
        };
      })(this)));
