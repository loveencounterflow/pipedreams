...
(function() {
  ...
  this["(v4) new_stream_from_pipeline (1a)"] = function(T, done) {
    ...
    create_frob_tee = function(settings) {
      var R, add, multiply, outputs, pipeline, receiver, square, unsquared;
      multiply = $((function(_this) {
        return function(data, send) {
      ...
      R = combine.apply(null, [receiver].concat(slice.call(pipeline)));
      outputs = {
        unsquared: unsquared
      };
      R['input'] = receiver;
    ...
    (function() {
      var frob, input, output, output_matchers, output_results, probes, write_data_using_push, write_data_using_write;
      probes = [1, 2, 3, 4, 5, 6, 7, 8, 9];
      output_matchers = [16, 36, 64, 100, 144, 196, 256, 324, 400];
      output_results = [];
      frob = create_frob_tee();
  ...
  if (module.parent == null) {
    include = ["(v4) new_stream_from_pipeline (1a)"];
    this._prune();
    this._main();
  }
