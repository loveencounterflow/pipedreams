...
(function() {
  ...
  if (module.parent == null) {
    include = ["(empty-string) can send empty strings (validate mississippi duplex works as such)", "(empty-string) duplexer2 works with empty strings", "(empty-string) new D.duplex, new_stream from pipeline work with empty strings"];
    this._prune();
    this._main();
  }
