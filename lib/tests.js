...
(function() {
  ...
  this["(v4) $select (demo)"] = function(T, done) {
    ...
    probes = [['fr', 1], ['fr', 2], ['fr', 3], ['fr', 4], '---', ['en,fr', 1], '---', ['*', 1], '---', ['en', 2], '---', ['de', 3], ['de', 4]];
    matchers = ["un", "deux", "troix", "beaucoup", "—————", "one", "un", "—————", "one", "un", "eins", "—————", "two", "—————", "drei", "viele", "guess we're done here"];
