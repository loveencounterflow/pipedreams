...
(function() {
  ...
  this.$split_tsv = function(settings) {
    ...
    * If `settings[ 'names' ]` is set to `'inline'`, field names are gleaned from the first non-discarded line
    ...
    var $name_fields, $skip_empty_fields, $skip_empty_lines, $skip_field_comments, $skip_line_comments, $split_line, $trim, comment_pattern, comments, is_comment, name_fields, names, pipeline, ref, ref1, ref2, ref3, skip_comments, skip_empty_lines, splitter, type, type_of_splitter, use_names;
    if (settings != null) {
    ...
    skip_empty_lines = !((ref1 = settings != null ? settings['empty'] : void 0) != null ? ref1 : false);
    use_names = (ref2 = settings != null ? settings['names'] : void 0) != null ? ref2 : null;
    comment_pattern = (ref3 = settings != null ? settings['comments'] : void 0) != null ? ref3 : '#';
    ...
    if (use_names != null) {
      ...
      name_fields = (function(_this) {
        return function(fields) {
          var R, field, i, idx, len, ref4;
          R = {};
          for (idx = i = 0, len = fields.length; i < len; idx = ++i) {
            field = fields[idx];
            R[(ref4 = names[idx]) != null ? ref4 : "field-" + idx] = field;
          }
          return R;
        };
      })(this);
    ...
    switch (type_of_splitter = CND.type_of(splitter)) {
      ...
      case 'function':
        $split_line = (function(_this) {
          return function() {
            return _this.$(function(line, send) {
              return send(splitter(line));
            });
          };
        })(this);
        break;
      default:
        throw new Error("expected a text, a RegEx or a function for splitter, got a " + type_of_splitter);
    }
    pipeline = [];
  ...
  this.$as_tsv = function() {
    var i, names, pipeline, ref, settings, stringify;
    ...
    pipeline = [
      ...
      })(this)), this.$('start', (function(_this) {
        return function(send) {
          return send((names.join('\t')) + '\n');
        };
      })(this))
    ];
    return this._rpr("as-tsv", "as-tsv", null, this.new_stream({
      pipeline: pipeline
    }));
  };
...
//# sourceMappingURL=plugin-tsv.js.map
