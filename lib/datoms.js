(function() {
  'use strict';
  var CND, LFT, assign, badge, copy, debug, echo, help, info, isa, jr, rpr, type_of, types, urge, validate, warn, whisper;
  ...
  this.freeze = LFT.freeze.bind(LFT);

  this.thaw = LFT.thaw.bind(LFT);
