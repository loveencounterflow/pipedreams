...
(function() {
  'use strict';
  var $, $as_type_datoms, $async, CND, PD, after, alert, badge, debug, defer, echo, every, help, info, is_empty, jr, log, rpr, select, urge, warn, whisper, wye_3, wye_4;
