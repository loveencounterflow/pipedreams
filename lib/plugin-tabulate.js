...
(function() {
  var $, $as_event, $as_row, $async, $cleanup, $dividers, $set_widths_etc, CND, D, _new_state, alert, as_row, as_text, badge, boxes, copy, debug, get_divider, help, keys_toplevel, ref, rpr, to_width, urge, validate_keys, values_alignment, values_overflow, warn, width_of,
  ...
  validate_keys = function(title, arity, got, expected) {
    var x;
