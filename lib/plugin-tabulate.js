...
(function() {
  var $, $as_event, $as_row, $async, $cleanup, $dividers, $finalize, $set_widths_etc, CND, D, _new_state, alert, as_row, as_text, badge, boxes, copy, debug, get_divider, help, keys_default, keys_toplevel, ref, rpr, to_width, urge, values_alignment, values_overflow, warn, width_of,
  ...
  this.$tabulate = function(settings) {
    ...
    pipeline = [$as_event(S), $set_widths_etc(S), $dividers(S), $as_row(S), $finalize(S), $cleanup(S)];
