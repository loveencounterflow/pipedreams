...
//.........................................................................................................
  ...
  this["select 1"] = async function(T, done) {
    var errmsg_pattern, i, len, matcher, method, probe, probes_and_matchers;
    probes_and_matchers = [[['^frob', '^frob'], true], [['^frob', '<frob'], false], [['^frob', '<>frob'], false], [['^frob', '<^>frob'], true], [['^frob', '<>^frob'], true], [['<frob', '<>^frob'], true], [['>frob', '<>^frob'], true], [['frob', '<>^frob'], null, "illegal event key 'frob'"], [['~copy', '~frob'], false], [['~copy', '~copy'], true], [['~copy', '^~copy'], true], [['~copy', '<>^~copy'], true]];
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      [probe, matcher, errmsg_pattern] = probes_and_matchers[i];
      method = function() {
