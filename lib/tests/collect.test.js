...
(function() {
  'use strict';
  var $, $add_data_region, $as_event, $async, CND, L, PD, badge, debug, defer, echo, help, info, inspect, jr, rpr, select, stamp, test, urge, warn, whisper, xrpr;
...
//.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["$collect with custom collector"] = async function(T, done) {
    var error, i, len, matcher, probe, probes_and_matchers;
    probes_and_matchers = [
      [
        [1,
...
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          var R, pipeline, values;
          values = probe;
          R = [];
          pipeline = [];
          pipeline.push(PD.new_value_source(values));
          pipeline.push($(function(d, send) {
            return send(d === '~collect' ? PD.new_system_event('collect') : d);
          }));
          pipeline.push($as_event());
