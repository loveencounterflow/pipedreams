...
(function() {
  ...
  module.exports = run = function(x) {
    var T, arity, check_count, error, error_handler, fail_count, failures, name, pass_count, supply_caller_to_error, test, test_count;
    T = {};
    test_count = 0;
    check_count = 0;
    pass_count = 0;
    ...
    supply_caller_to_error = (function(_this) {
      return function(delta, error) {
        ...
        debug('©h0ybR', BNP.get_caller_info(delta, error, true));
        warn('aborting');
        return process.exit();
      };
    })(this);
