...
(function() {
  'use strict';
  var CND, L, PATH, acquire_path, acquire_patterns, assign, badge, debug, echo, glob, help, info, is_bound, isa, jr, minimatch, override_sym, rpr, type_of, types, urge, validate, warn, whisper;
