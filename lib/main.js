...
(function() {
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this.$on_start = function(method) {
    ...
    return this.$on_first('null', (function(_this) {
      return function(data, send) {
        if (arity === 1) {
          method(send);
        } else {
  ...
  this.$on_stop = function(method) {
    ...
    return this.$on_last('null', (function(_this) {
      return function(data, send) {
        send(data);
        if (arity === 1) {
          return method(send);
  ...
  this.$on_last = function() {
    var arity, cache, i, method, tags;
    tags = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), method = arguments[i++];
    if (!CND.is_subset(tags, ['null'])) {
      throw new Error("allowed tag is 'null', got " + (rpr(tags)));
    }
    ...
    return this.$('null', function(data, send) {
      if (data != null) {
        ...
        if ((cache != null) || indexOf.call(tags, 'null') >= 0) {
          method(cache, send);
        } else {
          send(null);
        }
