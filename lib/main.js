...
(function() {
  var $, CND, DS, LODASH, PIPEDREAMS, alert, badge, debug, echo, help, info, log, rpr, through2, urge, warn, whisper,
    __slice = [].slice,
  ...
  this.new_hyphenator = function(hyphenation, min_length) {
    var HYPHER, Hypher;
    if (hyphenation == null) {
      hyphenation = null;
    }
  ...
  this.HTML.$collect_empty_tags = function() {
