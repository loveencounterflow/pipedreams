...
(function() {
  ...
  this.$split = function(matcher, mapper, settings) {
  ...
  this.$parse_csv = function(options) {
    var delimiter, field_names, headers, qualifier, ref, ref1, ref2, stringfoo;
    field_names = null;
    if (options == null) {
      options = {};
    }
  ...
  this.$split_each_line = function(settings) {
    var $skip_comments, $skip_empty, $split_line, $trim, comment_matcher, keep_empty, pipeline, ref, ref1, ref2, splitter;
    splitter = (ref = settings != null ? settings['splitter'] : void 0) != null ? ref : '\t';
    keep_empty = (ref1 = settings != null ? settings['empty'] : void 0) != null ? ref1 : false;
    comment_matcher = (ref2 = settings != null ? settings['comments'] : void 0) != null ? ref2 : '#';
    $trim = (function(_this) {
      return function() {
    ...
    $skip_comments = (function(_this) {
      return function() {
        ...
        if (CND.isa_text(comment_matcher)) {
          is_comment = function(field) {
            return field.startsWith(comment_matcher);
          };
        } else {
          is_comment = function(field) {
            return comment_matcher.test(field);
          };
        }
