...
(function() {
  var $map, CND, ES, S, alert, badge, combine, debug, echo, help, info, log, rnd_from_seed, rpr, urge, warn, whisper,
    slice = [].slice;
  ...
  this.TEE._from_confluence = (function(_this) {
    return function(confluence, settings) {
      var input, key, output, ref, ref1, ref2, ref3, value;
      ...
      confluence.tee = {
        ...
        input: input,
        output: output,
        inputs: Object.assign({}, (ref2 = settings['inputs']) != null ? ref2 : null),
        outputs: Object.assign({}, (ref3 = settings['outputs']) != null ? ref3 : null)
      };
      for (key in settings) {
        value = settings[key];
  ...
  (function(PIPEDREAMS) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (CND.isa_function(value = PIPEDREAMS[key])) {
        results.push(PIPEDREAMS[key] = value.bind(PIPEDREAMS));
      } else {
