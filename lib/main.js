(function() {
  var $, $async, $map, CND, DS, ES, LODASH, PIPEDREAMS, S, alert, badge, combine, debug, echo, get_random_integer, help, info, log, rnd_from_seed, rpr, urge, warn, whisper,
    slice = [].slice;
  ...
  this.create_fitting_from_pipeline = function(pipeline, settings) {
    ...
    * `outputs`: a copy of `settings[ 'outputs' ]` or a blank object.
    ...
    in a meaningful way.
     */
    var R, confluence, input, output, ref, ref1, type;
    if ((type = CND.type_of(pipeline)) !== 'list') {
      throw new Error("expected a list for pipeline, got a " + type);
    }
    confluence = this.combine.apply(this, pipeline);
    input = (ref = settings != null ? settings['input'] : void 0) != null ? ref : this.create_throughstream();
    output = (ref1 = settings != null ? settings['output'] : void 0) != null ? ref1 : this.create_throughstream();
  ...
  this.create_fitting_from_readwritestreams = function(readstream, writestream, settings) {
     ...
     */
    var R, confluence, input, output, ref, ref1;
    confluence = this._ES.duplex(readstream, writestream);
    input = (ref = settings != null ? settings['input'] : void 0) != null ? ref : this.create_throughstream();
    output = (ref1 = settings != null ? settings['output'] : void 0) != null ? ref1 : this.create_throughstream();
    input.pipe(confluence).pipe(output);
    R = {
