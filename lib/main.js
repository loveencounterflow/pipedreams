...
(function() {
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this._new_stream$duplexer2 = function(receiver, sender) {
    var R;
    R = (require('duplexer2'))({
      objectMode: true
    }, receiver, sender);
  ...
  this._new_stream_from_pipeline = function(pipeline, hints, settings) {
     ...
     */
    var R, as_bridged, handler, receiver, sender, transform, type;
    if (hints != null) {
    ...
    handler = (function(_this) {
      return function(error) {
        return R.emit('error', error(error != null ? help('ok') : void 0));
      };
    })(this);
    pipeline = (function() {
      var i, len, results;
    ...
    MSP.pipe.apply(MSP, slice.call(pipeline).concat([handler]));
    R = (require('duplexer2'))({
      objectMode: true
    }, receiver, sender);
    return R;
  ...
  this.$bridge = function(stream) {
    ...
    meaning.
     */
    var arity, bridge, extra, i, key, len, output, ref, results, sub_key, throughput, value;
    ...
    return this._rpr("↷", "bridge", extra, this.duplex(bridge, output));
