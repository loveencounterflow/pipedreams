...
(function() {
  ...
  this.create_fitting_from_pipeline = function(pipeline, settings) {
    ...
    * `outputs`: a copy of `settings[ 'outputs' ]` or a blank object.
    ...
    return this._create_fitting_from_confluence(confluence, settings != null ? settings : {});
  };
  ...
  this._create_fitting_from_confluence = function(confluence, settings) {
    var R, input, key, output, ref, ref1, value;
    input = (ref = settings['input']) != null ? ref : this.create_throughstream();
    output = (ref1 = settings['output']) != null ? ref1 : this.create_throughstream();
  ...
  D.stream_from_text = function() {
    var P, R, text;
    text = arguments[0], P = 2 <= arguments.length ? slice.call(arguments, 1) : [];
     ...
     */
    R = this.create_throughstream.apply(this, P);
    R.pause();
