...
(function() {
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this._new_stream$read_from_file = function() {
    var P, R, ref;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    R = (ref = require('fs')).createReadStream.apply(ref, P);
    return this._new_stream$wrap("✇⏵", R);
  };

  this._new_stream$write_to_file = function() {
    var P, R, ref;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    R = (ref = require('fs')).createWriteStream.apply(ref, P);
    return this._new_stream$wrap("✇⏺", R);
  };
  ...
  this._new_stream$split_buffer = function(matcher) {
    ...
    return this._new_stream$wrap("✀ " + (rpr(matcher)), R);
  };

  this._new_stream$throttle_bytes = function(bytes_per_second) {
    var R;
    R = new (require('throttle'))(bytes_per_second);
    return this._new_stream$wrap("⏳ " + bytes_per_second + " B/s", R);
  };

  this._new_stream$wrap = function(sigil, stream) {
    ...
    🔵🔿🕀🗟🛈
     */
    var _inspect, g, inspect, r;
    r = CND.lime.bind(CND);
    g = CND.grey.bind(CND);
    if ((_inspect = stream.inspect) != null) {
      if (CND.isa_function(sigil)) {
        inspect = function() {
          return (r(sigil())) + (g(" [")) + _inspect() + (g("],"));
        };
      } else {
        inspect = function() {
          return (r(sigil)) + (g(" [")) + _inspect() + (g("],"));
  ...
  this._new_stream = function(seed, hints, settings) {
    ...
    return this._new_stream$wrap('P', MSP.through.obj());
  };
  ...
  this._new_stream_from_path = function(path, hints, settings) {
    ...
    if (role === 'read') {
      if (use_line_mode) {
        pipeline.push(this._new_stream$read_from_file(path, settings));
      ...
      pipeline.push(this.$bridge(this._new_stream$write_to_file(path, settings)));
    }
    return this.new_stream({
      pipeline: pipeline
    });
  ...
  this._new_stream_from_pipeline = function(pipeline, hints, settings) {
    ...
    return this._new_stream$wrap(inspect, (ref = MSP.pipeline).obj.apply(ref, pipeline));
  };
  ...
  this.$pass_through = function() {
    return this._new_stream$wrap('⦵', MSP.through.obj());
  };
  ...
  this._new_remit = function(mode, method) {
    var arity, flush, get_send, has_error, main, x_sigil;
    arity = method.length;
    ...
    if (arity === 1) {
      ...
      return this._new_stream$wrap("≒d", MSP.through.obj(main, flush));
    }
    if (arity === 3) {
      flush = function(callback) {
    ...
    x_sigil = arity === 2 ? 'ds' : 'dse';
    return this._new_stream$wrap("≒" + x_sigil, MSP.through.obj(main, flush));
  };
  ...
  this.$split = function(settings) {
    ...
    var R, encoding, matcher, ref, ref1, type;
  ...
  this.$decode = function(encoding) {
    ...
    return this._new_stream$wrap("?" + encoding, this.$((function(_this) {
      return function(data, send) {
  ...
  this.$sort = function(sorter, settings) {
    ...
    return this._new_stream$wrap('∑ sort', this.$((function(_this) {
  ...
  this.$collect = function(on_end) {
    ...
    collector = [];
    return this._new_stream$wrap("⚞", this.$(function(data, send, end) {
      if (data != null) {
        collector.push(data);
      }
      if (end != null) {
  ...
  this.$spread = function(settings) {
    ...
    return this._new_stream$wrap("⚟", this.$((function(_this) {
      return function(data, send) {
  ...
  this.$bridge = function(stream) {
    ...
    return this._new_stream$wrap('bridge', this.$((function(_this) {
      return function(data, send, end) {
        if (data != null) {
          stream.write(data);
          send(data);
