...
(function() {
  ...
  D.create_fitting = function(transforms, settings) {
    ...
    * `outputs`: a copy of `settings[ 'outputs' ]` or a blank object.
    ...
    confluence = CND.isa_list(transforms) ? D.combine.apply(D, transforms) : transforms;
    ...
    R = {
      ...
      input: input,
      output: output,
      inputs: settings['inputs'] != null ? CND.LODASH.clone(settings['inputs']) : {},
      outputs: settings['outputs'] != null ? CND.LODASH.clone(settings['outputs']) : {}
    };
    return R;
  };
