...
(function() {
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this._new_devnull_stream = function() {
    ...
    return this._rpr("⏚", "devnull", null, this.new_stream({
      pipeline: pipeline
    }));
  };
  ...
  this._new_stream_from_pipeline = function(pipeline, hints, settings) {
     ...
     */
    var as_bridged, i, input, len, output, transform, type;
    if (hints != null) {
    ...
    as_bridged = (function(_this) {
      return function(transform) {
        if (_this.isa_readonly_stream(transform)) {
  ...
  this.$split_2 = function(settings) {
    var encoding, extra, matcher, matcher_bfr, output, pipeline, ref, ref1, ref2, splitter, strip, type;
    matcher = (ref = settings != null ? settings['matcher'] : void 0) != null ? ref : '\n';
    if ((type = CND.type_of(matcher)) !== 'text') {
      throw new Error("expected a text, got a " + type);
    }
    ...
    if (strip) {
      pipeline.push(this.$((function(_this) {
        return function(data, send) {
          ...
          if (!data.includes(matcher_bfr, position)) {
            return send(data);
          }
          return send(data.slice(0, position));
        };
      })(this)));
    }
    if (encoding !== 'buffer') {
  ...
  this.$bridge = function(stream) {
    ...
    meaning.
     */
    var arity, bridge, extra, output, throughput;
    ...
    output = this._rpr("output", "output", null, this.new_stream());
    ...
    bridge = this.new_stream({
      pipeline: [throughput, stream]
    });
    extra = (rpr(bridge)) + ' ↝ ' + (rpr(output));
    return this._rpr("↷", "bridge", extra, MSP.duplex.obj(bridge, output));
  };
