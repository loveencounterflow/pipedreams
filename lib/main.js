...
(function() {
  var CND, _rpr, alert, badge, debug, echo, help, info, insp, log, rpr, urge, warn, whisper, x_count,
    slice = [].slice,
  ...
  rpr = function() {
    ...
    return debug('33321', (require('util')).inspect(P));
  };
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this._new_stream$through = function() {
    var P, ref;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return (ref = require('through2')).obj.apply(ref, P);
  };
