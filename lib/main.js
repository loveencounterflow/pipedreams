...
(function() {
  ...
  this.$split_each_line = function(settings) {
    var $split_line, comment_matcher, keep_empty, ref, ref1, ref2, splitter;
    ...
    comment_matcher = (ref2 = settings != null ? settings['comments'] : void 0) != null ? ref2 : false;
    $split_line = (function(_this) {
      return function() {
        return _this.$(function(data, send) {
          return send(data.split(splitter));
        });
      };
    })(this);
    return this.new_stream({
      pipeline: [this.$split(), $split_line()]
    });
  };
