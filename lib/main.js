    ...
    handlers = {
      doctype: (function(_this) {
        return function(name, pid, sid) {
          return handler(null, ['doctype', name, pid, sid]);
        };
      })(this),
      endTag: (function(_this) {
        return function(name) {
          return handler(null, ['close-tag', name]);
        };
      })(this),
      text: (function(_this) {
        return function(text) {
          return handler(null, ['text', CND.escape_html(text)]);
        };
      })(this),
      comment: (function(_this) {
        return function(text) {
          return handler(null, ['comment', CND.escape_html(text)]);
        };
      })(this),
        ...
        return function(name, a) {
          ...
          if (__indexOf.call(lone_tags, name) >= 0) {
            if (name === 'wbr') {
              ...
              return handler(null, ['lone-tag', name, attributes]);
            }
          } else {
            return handler(null, ['open-tag', name, attributes]);
          }
        };
      })(this)
    };
  ...
  this.HTML.$parse = function() {
    return $((function(_this) {
      return function(html, send) {
        return _this.parse(html, function(error, event) {
          if (error != null) {
            send.error(error);
          }
          return send(event);
