...
(function() {
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this._new_remit.tags = ['null', 'first', 'last', 'start', 'stop'];
  ...
  this.$on_start = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    this._deprecate("$on_start is deprecated; use $ 'start' instead");
  ...
  this.$on_stop = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    this._deprecate("$on_stop is deprecated; use $ 'stop' instead");
  ...
  this.$on_first = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    this._deprecate("$on_first is deprecated; use $ 'first' instead");
  ...
  this.$on_last = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    this._deprecate("$on_last is deprecated; use $ 'last' instead");
