...
(function() {
  var $map, CND, ES, S, alert, badge, combine, debug, echo, help, info, log, pluck, rnd_from_seed, rpr, urge, warn, whisper,
    slice = [].slice;
  ...
  this.$async_v4 = function(method) {
    var _send_end, _stream_end, arity, has_end_argument, ref;
    ...
    _send_end = null;
    _stream_end = null;
    return retun(this.new_stream_from_pipeline([]));
  };
  ...
  this.collect = function(stream, handler) {
     ...
     */
    R = [];
    stream.pipe(this.$((function(_this) {
      return function(data, send, end) {
        if (data !== void 0) {
          R.push(data);
        }
