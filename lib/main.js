...
(function() {
  ...
  this._new_stream_from_path = function(path, hints, settings) {
    var R, expected, fs_settings, got, pipeline, role, role_count, type, use_line_mode, x;
  ...
  this._new_stream_from_path._hints = ['utf-8', 'utf8', 'binary', 'read', 'write', 'append', 'lines'];
