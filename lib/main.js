...
(function() {
  var CND, MSP, alert, badge, debug, echo, help, info, log, pluck, rnd_from_seed, rpr, split2, stringfoo, urge, warn, whisper;
  ...
  this.$split = function(matcher, mapper, settings) {
    return split2(matcher, mapper, settings);
  };

  this.$sort = function(sorter, settings) {
    var arity, collect, collector, ref;
