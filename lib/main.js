...
(function() {
  var CND, alert, badge, debug, deprecate, echo, help, info, insp, log, pluck, rnd_from_seed, rpr, urge, warn, whisper,
    slice = [].slice,
  ...
  * Wrap all stream/transform creation calls so that printing of shorthand descriptions of pipelines becomes
  ...
  this.$pass_through = function() {
    return this._rpr("⦵", "pass-through", null, this._new_stream$through());
  };
  ...
  this.$on_start = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    deprecate("$on_start is deprecated; use $ 'start' instead");
    return this.$.apply(this, ['start'].concat(slice.call(P)));
  };

  this.$on_stop = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    deprecate("$on_stop is deprecated; use $ 'stop' instead");
    return this.$.apply(this, ['stop'].concat(slice.call(P)));
  };

  this.$on_first = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    deprecate("$on_first is deprecated; use $ 'first' instead");
    return this.$.apply(this, ['first'].concat(slice.call(P)));
  };

  this.$on_last = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    deprecate("$on_last is deprecated; use $ 'last' instead");
    return this.$.apply(this, ['last'].concat(slice.call(P)));
  };

  this.$_on_start = function(method) {
    var arity, ref;
