...
(function() {
  ...
  this.remit_async_spread = function(method) {
    ...
    $call = (function(_this) {
      return function() {
        return _this.$async(function(event, done) {
          var collect;
    ...
    $spread = (function(_this) {
      return function() {
        return _this.remit(function(collection, send, end) {
          var event, i, len;
          if (collection != null) {
  ...
  this.$join = function(joiner) {
     ...
     */
    return this.combine([
      this.$collect(), this.remit((function(_this) {
  ...
  this.spawn_and_read_lines = function() {
    ...
    input.pipe(this.$split()).pipe(this.remit((function(_this) {
  ...
  this.collect = function(stream, handler) {
     ...
     */
    R = [];
    stream.pipe(this.remit((function(_this) {
      return function(data, send, end) {
        if (data !== void 0) {
          R.push(data);
        }
